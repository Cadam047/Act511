...
st.button(f"plus {'10' if st.session_state.ten_x else '1'}", key="increment", on_click=increment)
st.button(f"minus {'10' if st.session_state.ten_x else '1'}", key="decrement", on_click=decrement)